...
int reverse_str(const char* str, char **result)
{
...
int to_uppercase_odd_positions(const char* str, char** result)
{
...
int concatenate_strings(char** array_of_pointers_on_strings, char** result, unsigned int seed,
...
int main(int argc, char *argv[])
{
    ...
    switch (flag[1])
    {
        ...
        case 'c':
            ...
            switch (concatenate_strings(array_of_pointers_on_strings, &result, seed, count_of_strings))
            {
                case 0:
